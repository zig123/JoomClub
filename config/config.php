 ...
 * Настройки HTML вида
 */
$config['view']['skin']        = 'joomclub';                                                              // шаблон(скин)
...
$config['view']['img_max_size_url'] = 200;    // максимальный размер картинки в kB для загрузки по URL
 ...
 */
$config['block']['stream']['row'] = 7;                       // сколько записей выводить в блоке "Прямой эфир"
...
$config['sys']['cache']['solid']  = false;               // Настройка использования раздельного и монолитного кеша для отдельных операций
 ...
 */
$config['acl']['create']['blog']['rating']                =  1000000;  // порог рейтинга при котором юзер может создать коллективный блог
...
$config['module']['blog']['index_good']      =  1;   // Рейтинг топика выше которого(включительно) он попадает на главную
...
$config['module']['comment']['max_tree'] = 10;           // Максимальная вложенность комментов при отображении
...
$config['block']['rule_index_blog'] = array(
	...
	'blocks'  => array(
			'right' => array('stream'=>array('priority'=>100),'tags'=>array('priority'=>10),'blogs'=>array('params'=>array(),'priority'=>50)),
			'toptop' => array()
		),
	'clear' => false,
);
...
$config['compress']['css']['remove_last_;']       = false;
