...
{$aHtmlHeadFiles.js}
  ...
  <link rel="stylesheet" href="http://joomclub.net/plugins/aceadminpanel/templates/skin/admin_new/assets/bootstrap/css/bootstrap.css" type="text/css" />
  <link rel="stylesheet" href="http://joomclub.net/plugins/aceadminpanel/templates/skin/admin_new/assets/bootstrap/css/bootstrap-responsive.css" type="text/css" />
...
{hook run='body_end'}
<script type="text/javascript" src="http://joomclub.net/plugins/aceadminpanel/templates/skin/admin_new/assets/bootstrap/js/bootstrap.js"></script>
</body>
</html>