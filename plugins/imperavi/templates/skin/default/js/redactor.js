...
(function($){
	...
	Redactor.prototype = {
		...
		insertTable: function()
		{
			...
			var table = $('<table class="table table-striped" id="table' + tableid + '"><tbody></tbody></table>');
				...
				if (this.opts.imageGetJson !== false)
				{
					$.getJSON(this.opts.imageGetJson, $.proxy(function(data) {
						...
						$.each(data, $.proxy(function(key, val)
						{
							...
							var img = $('<img src="' + val.image + '" title="'+val.title+'" class="redactorfolder redactorfolder' + folderkey + '" rel="' + val.image + '" title="' + thumbtitle + '" />');
        ...
        showLs: function() {
            this.saveSelection();
            this.modalInit('Вставить ник', 'lsuser', 375, $.proxy(function()
            {
        ...
        insertLsUser: function()
        {
            ...
            this._insertLsUser('<ls user='+text+'>&nbsp</ls>');
