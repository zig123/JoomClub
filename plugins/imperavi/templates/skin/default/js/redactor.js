...
(function($){
	...
	var Redactor = function(element, options)
	{
		...
		if (typeof options !== 'undefined' && typeof options.lang !== 'undefined' && options.lang !== 'en' && typeof RELANG[options.lang] !== 'undefined') 
		{
			...
			/*ZharinaViktor*/
			arrErrId = [0,
						RLANG.err_filename_not_set,
						RLANG.err_type_restricted,
						RLANG.err_file_is_not_image,
						RLANG.err_file_is_too_large,
						RLANG.err_create_image_dir,
						RLANG.err_filecopy_error,
						RLANG.err_file_is_image,
						RLANG.err_url_struct_is_not_set
					];
			/*ZharinaViktor*/
		}		
		...
		this.opts = $.extend({
			...
			/*ZharinaViktor*/
			modal_lsuser: String() + 
					'<label>' + RLANG.ls_user_text + '</label>' +
					'<input type="text" size="30" value="" id="redactor_lsuser" />' +
					'<div id="redactor_modal_footer">' +
						'<span class="redactor_btns_box">' +
							'<input type="button" id="redactor_insert_lsuser_btn" value="' + RLANG.insert + '" />' +
							'<a href="javascript:void(null);" id="redactor_btn_modal_close">' + RLANG.cancel + '</a>' +
						'</span>' +
					'</div>',

			modal_smiles: String() + 
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/aa.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/ab.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/ac.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/ad.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/ae.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/af.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/ag.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/ah.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/ai.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/aj.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/ak.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/al.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/am.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/an.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/ao.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/ap.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/aq.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/ar.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/as.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/at.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/au.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/av.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/aw.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/ax.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/ay.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/az.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/ba.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bb.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bc.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bd.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/be.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bf.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bg.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bh.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bi.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bj.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bk.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bl.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bm.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bn.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bo.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bp.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bpj.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bpj1.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bpl.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bpm.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bpn.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bpo.gif" class="smile_clickable" />'+
					'<img src="'+DIR_WEB_ROOT+'/uploads/smiles/bpp.gif" class="smile_clickable" />'+
					'<div id="redactor_modal_footer">' +
						'<span class="redactor_btns_box">' +
							'<input type="button" id="redactor_insert_smiles_btn" value="' + RLANG.insert + '" />' +
							'<a href="javascript:void(null);" id="redactor_btn_modal_close">' + RLANG.cancel + '</a>' +
						'</span>' +
					'</div>',
	...
	Redactor.prototype = {
		...
		{
			/*ZharinaViktor - var allowed = ["ls"*/

			var allowed = ["ls","code", "span", "div", "label", "a", "br", "p", "b", "i", "del", "strike", "img", "video", "audio", "iframe", "object", "embed", "param", "blockquote", "mark", "cite", "small", "ul", "ol", "li", "hr", "dl", "dt", "dd", "sup", "sub", "big", "pre", "code", "figure", "figcaption", "strong", "em", "table", "tr", "td", "th", "tbody", "thead", "tfoot", "h1", "h2", "h3", "h4", "h5", "h6"];
		...
		resize: function(e)
		{
			...
			if (s_new >= 0)
			{
				...
				//this.element_resize.get(0).height = s_new + 'px';
				//this.element_resize_parent.get(0).height = s_new + 'px';
			}
		},
		...
		imageSave: function(el)
		{
			...
			{
				$(el).addClass('image-center');
				$(el).css({'float': 'none', 'display': 'block', margin: '0 auto'});
			}
			/*ZharinaViktor*/
			else
			{
		...
		_imageSet: function(json, link)
		{
			...
			if (link !== true)
			{
				...
				if (data.error_id) {
					var err_msg = this.getErrMsg(data.error_id);
					alert(err_msg);
					this.modalClose();
				} else {
		...
		fileUploadCallback: function(json)
		{
			...
			/*ZharinaViktor*/
				...
				var link = '<a href="' + data.filelink + '">' + text + '</a>&nbsp';
		...
		/*ZharinaViktor code*/
		getErrMsg: function(error_id) {
			for (var err_idx = 0; err_idx <= arrErrId.length; err_idx++) {
				if (err_idx == parseInt(error_id)) {
					return arrErrId[err_idx];
				}
			}
		},
		...
		showLs: function() {
			...
			this.modalInit('Вставить юзера', 'lsuser', 375, $.proxy(function()
				{				
					$('#redactor_insert_lsuser_btn').click($.proxy(this.insertLsUser, this));
				}, this), 
				function() { 
					$('#redactor_lsuser').focus(); 
				}
			)
		},

		insertLsUser: function()
		{
			var text = $('#redactor_lsuser').val();
			
			this._insertLsUser('<a title=lsuser>' +  text + '</a><ls user='+text+'></ls> &nbsp');

		},
		_insertLsUser: function(a)
		{
			if ($.browser.msie)
			{
				$(this.doc.getElementById('span' + this.spanid)).replaceWith(a);
		...
		showSmiles: function() {
			...
			this.modalInit('Смайлы', 'smiles', 375, $.proxy(function()
				{		
					$(".smile_clickable").click(function () {
				      $(".smile_clickable").removeClass("highlight");
				      $(this).addClass("highlight");
				    });

					$('#redactor_insert_smiles_btn').click($.proxy(this.insertSmiles, this));
				}, this)
			);
		},
		...
		{
			var text = $('.highlight').attr("src");
			
			this._insertSmiles('<img src="' +  text + '"/>');

		},
		_insertSmiles: function(a)
		{
			if ($.browser.msie)
			{
				$(this.doc.getElementById('span' + this.spanid)).replaceWith(a);
			...
			{
				this.execCommand('inserthtml', a+'&nbsp');
			}
		...
		{
			var spoiler_header 	= '<div class = "sp-head unfolded">Скрытый текст</div>';
			var spoiler_body 	= '<div class = "sp-body">'+this.getSelection()+'</div>';

			this.execCommand('inserthtml', '&nbsp<div class = "sp-wrap">' + spoiler_header + spoiler_body + '</div>&nbsp');
			this.syncCode();
		},

		insertHideText: function() 
		{
			this.execCommand('inserthtml', '&nbsp<hide>' + this.getSelection() + '</hide>&nbsp');
			this.syncCode();
		},

		insertBluePost: function() 
		{
			this.execCommand('inserthtml', '&nbsp<div class="bluepost">'+
												'<div class="bluepost-content">' +
													'<span>Blue Post</span>' +
													'<p class="justify">' + this.getSelection() + '</p>'+
												'</div>'+
											'</div>&nbsp'
							);
			this.syncCode();
	...
	/*ZharinaViktor*/
	$.fn.insertLs = function()
	{
		this.data('redactor').showLs();
	};
