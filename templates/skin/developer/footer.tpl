	...
	<footer class="container">
	  <div class="row-fluid footer">
		...
		<div class="copyright span3">
			<ul class="nav nav-list">
				<li  class="nav-header">Комнда</li>
				<li><a href="http://joomline.ru/" title="Менеджер">Менеджмент - </a></li>
				<li><a href="#" title="Программирование">Программирование - </a></li>
				<li><a href="#" title="Дизайн">Дизайн - </a></li>
				<li><a href="№" title="Верстка">Верстка - </a></li>
			</ul>
		</div>
