...
<form action="" method="POST" enctype="multipart/form-data">
	...
	<textarea name="talk_text" id="talk_text" rows="12" class="input-text input-width-full mce-editor markitup-editor input-width-full">{$_aRequest.talk_text}</textarea>
	{else}
	<textarea name="talk_text" id="redactor" rows="12" class="input-text input-width-full input-width-full">{$_aRequest.talk_text}</textarea>
	{/if}	
	</p>
