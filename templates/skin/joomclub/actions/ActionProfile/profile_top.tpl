  ...
  <div class="page-header">
	...
	<div class="vote-profile span6" style="max-height: 14px!important;margin-top: 10px">
		...
		<div id="vote_area_user_{$oUserProfile->getId()}" class="pull-right vote-topic
			...
			<div class="vote-item vote-down" onclick="return ls.vote.vote({$oUserProfile->getId()},this,-1,'user');" title="{$aLang.topic_vote_down}"><span><i class="ico-down"></i></span></div>
			...
			<div class="vote-item vote-up" onclick="return ls.vote.vote({$oUserProfile->getId()},this,1,'user');" title="{$aLang.topic_vote_up}"><span><i class="ico-up"></i></span></div>
		</div>
	</div>
    <div class="cls"></div>
