{if $sMenuItemSelect=='index'}
	<div class="btn-group">
		<a href="{cfg name='path.root.web'}/" class="{if $sMenuSubItemSelect=='good'}active {/if}btn btn-primary">{$aLang.blog_menu_all_good}</a>
		...
		<a class="{if $sMenuSubItemSelect=='top'}active {/if}btn btn-primary" href="{router page='index'}top/">{$aLang.blog_menu_all_top}</a>
