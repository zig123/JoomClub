		...
		<ul class="topic-info">
			...
			<li class="topic-info-vote">
				<div id="vote_area_topic_{$oTopic->getId()}" class="vote-topic
					...
					<div class="vote-item vote-down" onclick="return ls.vote.vote({$oTopic->getId()},this,-1,'topic');"><span><i class="ico-up"></i></span></div>
					...
					<div class="vote-item vote-up" onclick="return ls.vote.vote({$oTopic->getId()},this,1,'topic');"><span><i class="ico-down"></i></span></div>
					{if $bVoteInfoShow}
