<?php /* Smarty version Smarty-3.1.8, created on 2012-09-21 08:51:30
         compiled from "/var/www/nightguard/data/www/joomclub.net/templates/skin/joomclub/actions/ActionTopic/add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1936613435505bf25249b425-81705838%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ebad18b504bf2130ce73f707908507e31b731894' => 
    array (
      0 => '/var/www/nightguard/data/www/joomclub.net/templates/skin/joomclub/actions/ActionTopic/add.tpl',
      1 => 1347808593,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1936613435505bf25249b425-81705838',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_505bf2525e65d1_15231021',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_505bf2525e65d1_15231021')) {function content_505bf2525e65d1_15231021($_smarty_tpl) {?><?php if (!is_callable('smarty_function_hook')) include '/var/www/nightguard/data/www/joomclub.net/engine/modules/viewer/plugs/function.hook.php';
...
:</label>
	...
	<?php }else{ ?>
	<textarea name="topic_text" id="redactor" rows="20" class="input-text input-width-full"><?php echo $_smarty_tpl->tpl_vars['_aRequest']->value['topic_text'];?>
</textarea>
	<?php }?>
	<?php if (!$_smarty_tpl->tpl_vars['oConfig']->value->GetValue('view.tinymce')){?>
